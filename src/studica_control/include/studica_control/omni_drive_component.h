#ifndef OMNI_DRIVE_COMPONENT_H
#define OMNI_DRIVE_COMPONENT_H
...
public:
    static std::shared_ptr<rclcpp::Node> initialize(rclcpp::Node *control, std::shared_ptr<OmniOdometry> odom, std::shared_ptr<VMXPi> vmx);
    explicit OmniDrive(const rclcpp::NodeOptions & options);
    OmniDrive(
...
private:
    ...
    std::shared_ptr<studica_control::OmniOdometry> odom_;
